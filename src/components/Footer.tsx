    ...
    <footer className="bg-slate-900 text-slate-400 py-16 border-t border-slate-800">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-6">
              Orlando's leading mobile RV detailing and restoration specialists. Bringing showroom quality directly to your doorstep.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center gap-3">
                ...
                <span>info@rvdetailing.com</span>
              </li>
              <li className="flex items-center gap-3 text-balance">
                <MapPin size={16} className="text-blue-600" />
                <span>Serving Orlando & Central Florida</span>
              </li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-800 flex flex-col md:row items-center justify-between gap-4 text-xs">
          <p>© {new Date().getFullYear()} RVDetail. All rights reserved.</p>
